// scripts/register-metatron-tenant.ts
...
async function registerMETATRONTenant() {
  ...
  try {
    ...
    if (existingApp) {
      console.log('⚠️  既存の申請が見つかりました:', existingApp.status);
