...
export const TOKEN_MASTER_DATA: Record<TokenId, TokenConfig> = {
  ...
  JPYC: {
    ...
    addresses: {
      testnet: import.meta.env.VITE_JPYC_TESTNET_ADDRESS || '0xE7C3D8C9a439feDe00D2600032D5dB0Be71C3c29', // Polygon Mainnet JPYC（電子決済手段・EIP-3009対応）※テスト用にmainnetアドレス使用
      mainnet: import.meta.env.VITE_JPYC_MAINNET_ADDRESS || '0xE7C3D8C9a439feDe00D2600032D5dB0Be71C3c29', // Polygon Mainnet JPYC（電子決済手段・EIP-3009対応）
    },
