...
export const TOKEN_MASTER_DATA: Record<TokenId, TokenConfig> = {
  ...
  JPYC: {
    ...
    addresses: {
      testnet: import.meta.env.VITE_JPYC_TESTNET_ADDRESS || '0x6AE7Dfc73E0dDE2aa99ac063DcF7e8A63265108c', // Polygon Mainnet JPYC v2（電子決済手段・EIP-3009対応）※テスト用にmainnetアドレス使用
      mainnet: import.meta.env.VITE_JPYC_MAINNET_ADDRESS || '0x6AE7Dfc73E0dDE2aa99ac063DcF7e8A63265108c', // Polygon Mainnet JPYC v2（電子決済手段・EIP-3009対応）
    },
